...
Object.keys(locationJSONList).forEach((key: string) => {
    ...
    locationTemplate.enemyList.forEach((enemyName: string) => {
        locationEnemyList.push(Object.values(enemyList).find((e: any) => e.name === enemyName)) 
    })
